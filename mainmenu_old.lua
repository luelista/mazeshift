...
function mainmenu_old:enter()
   ...
   mainmenu_old.menu:add("xxxxxxx", function() Gamestate.switch(labyrinth, 1)  end)
   mainmenu_old.menu:add("xxxxxxx", function() Gamestate.switch(labyrinth, 2)  end)
   mainmenu_old.menu:add("FULLSCREEN", function()   end)
